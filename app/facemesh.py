...
class FaceMesh:
    def __init__(self):
        ...
        self.model = load_model("d:/study_data/_save/gg16_project10.h5")
    ...
    def predict(self, path):
        ...
        긍정적인 영향을 미치고자 구체적으로 계획을 세워 이행해 나갑니다.'
            ...
            result = '남자가 꼬이고 남편때문에 마음고생할 수 있는 이마입니다. 성격이 남자다운면도 있고 서글서글하고 붙임성이 \
        ...
        다채로우면서 파란만장하고 기복이 심한 편임 \:'
            ...
            result = '눈썹이 재복이 좋은 눈썹입니다. 눈은 내조를 잘하는 눈입니다. \
